...
training_data_s3_uri = 's3://{}/{}/housing.csv'.format(
    BUCKET_NAME, PREFIX)
validation_data_s3_uri = 's3://{}/{}/housing.csv'.format(
    BUCKET_NAME, PREFIX)
...
boston_estimator = Estimator(
    ...
    tags=[{"Key": "email",
           "Value": "divyanshu.dimri@jai-kisan.com"}])

boston_estimator.fit({'training': training_data_s3_uri,
                      'testing': validation_data_s3_uri}, wait=False)
